...
import icon4 from './iconsMenu/Vectoricon-4.svg'
    ...
    return (
        <div>
            ...
            <div>
                ...
                <img src={icon2} alt="brand" />
                <img src={icon3} alt="brand" />
                <img src={icon4} alt="brand" />
                <img src={icon5} alt="brand" />
                <img src={icon6} alt="brand" />
                <img src={icon7} alt="brand" />
                <img src={icon7} alt="brand" />
                <img src={icon7} alt="brand" />
                <img src={icon7} alt="brand" />
                <img src={icon7} alt="brand" />
